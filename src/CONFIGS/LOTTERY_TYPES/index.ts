const LOTTERY_TYPES: any = {
  'PK10': {
    ...
    SUMMATION_0_1_SMALL_UPPER_BOUND_NUMBER: 10,
    SUMMATION_0_1_LARGE_LOWER_BOUND_NUMBER: 12,
    SUMMATION_0_1_DEUCE_SMALL_LARGE_NUMBERS: [11],
    SUMMATION_0_1_DEUCE_ODD_EVEN_NUMBERS: [11],
  },
  'SSC': {
