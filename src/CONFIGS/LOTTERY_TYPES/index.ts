const LOTTERY_TYPES: any = {
  'PK10': {
    ...
    SUMMATION_1_2_SMALL_UPPER_BOUND_NUMBER: 10,
    SUMMATION_1_2_LARGE_LOWER_BOUND_NUMBER: 12,
    SUMMATION_1_2_DEUCE_SMALL_LARGE_NUMBERS: [11],
    SUMMATION_1_2_DEUCE_ODD_EVEN_NUMBERS: [11],
  },
  'SSC': {
