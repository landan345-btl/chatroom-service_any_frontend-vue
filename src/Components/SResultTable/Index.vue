    ...
    <div>
      ...
      <div class="table-con w-100" dir=rtl>
        <table class="faloat-right text-center">
          <tbody>
            <tr>
              <template v-if="40 <oddEvenOrSmallOrLargeStrings.length"> 
                <td v-for="(aOddEvenOrSmallOrLarge, iIndex ) in 40 - oddEvenOrSmallOrLargeStrings.length" :key="iIndex" :class="iIndex % 2 === 1 ? 'background-even':''" >
